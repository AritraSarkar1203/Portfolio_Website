...
const Contact = () => {
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start py-10">
        {/* Left Section */}
        <div className="lg:flex lg:flex-col lg:justify-between">
          ...
          <p className="mt-4 text-gray-500">
            I'm always excited to connect and collaborate. Whether it's a
            project, feedback, or just to say hi, feel free to reach out!
          </p>
          <div className="mt-6 flex items-center space-x-4">
            {socialLinks.map(({ href, icon, alt }, index) => (
              <a
                ...
                className="w-12 h-12 flex items-center justify-center rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-100 hover:text-gray-800 transition"
                title={alt}
              >
                {icon}
              </a>
        ...
        {/* Right Section */}
        <form
          action="https://getform.io/f/awnnzqdb"
          method="POST"
        ...
        >
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-700 focus:outline-none focus:ring focus:ring-blue-300"
              />
            </div>
          ...
          <button
            type="submit"
            className="mt-6 w-full rounded-lg bg-blue-600 px-4 py-2 text-white font-medium hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300"
          >
            Submit
          </button>
        </form>
